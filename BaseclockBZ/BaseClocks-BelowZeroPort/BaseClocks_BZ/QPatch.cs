...
namespace BaseClocks
{
    ...
    public  class QPatch : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            AssetBundle assetBundle = AssetBundle.LoadFromFile("./BepInEx/plugins/BaseClocks_BZ/clocks");
            AssetBundle assetBundleTMP = AssetBundle.LoadFromFile("./BepInEx/plugins/BaseClocks_BZ/clocks_tmp");

            s_ModPath = "./BepInEx/plugins/BaseClocks_BZ/";
            ...
            if (renderer != null)
                renderer.material.color = new Color(Convert.ToByte(BaseClocksConfig.ClockFaceColor.r), Convert.ToByte(BaseClocksConfig.ClockFaceColor.g), Convert.ToByte(BaseClocksConfig.ClockFaceColor.b));


            var renderer1 = actualTimeAnalogueClock.MinuteHand.GetComponent<Renderer>();
            if (renderer1 != null)
                renderer1.material.color = new Color(Convert.ToByte(BaseClocksConfig.ClockFaceColor.r), Convert.ToByte(BaseClocksConfig.ClockFaceColor.g), Convert.ToByte(BaseClocksConfig.ClockFaceColor.b), Convert.ToByte(BaseClocksConfig.ClockFaceColor.a));


            var renderer2 = actualTimeAnalogueClock.SecondHand.GetComponent<Renderer>();
            if (renderer2 != null)
                renderer2.material.color = new Color(Convert.ToByte(BaseClocksConfig.ClockFaceColor.r), Convert.ToByte(BaseClocksConfig.ClockFaceColor.g), Convert.ToByte(BaseClocksConfig.ClockFaceColor.b), Convert.ToByte(BaseClocksConfig.ClockFaceColor.a));
            var Clock = analogueBaseClock.gameObject.GetComponent<Renderer>();
            if (Clock != null)
                Clock.material.color = new Color(Convert.ToByte(BaseClocksConfig.ClockFaceColor.r), Convert.ToByte(BaseClocksConfig.ClockFaceColor.g), Convert.ToByte(BaseClocksConfig.ClockFaceColor.b), Convert.ToByte(BaseClocksConfig.ClockFaceColor.a));
            ...
            KnownTechHandler.AddRequirementForUnlock(analogueClockBuildable.Info.TechType, TechType.ArcticPeeper);
            ...
            if (safeToLoadDigitalClock)
            {
                ...
                if (renderer4 != null)
                    digitalClock.Text.color = new Color(Convert.ToByte(BaseClocksConfig.ClockFaceColor.g), Convert.ToByte(BaseClocksConfig.ClockFaceColor.g), Convert.ToByte(BaseClocksConfig.ClockFaceColor.b), Convert.ToByte(BaseClocksConfig.ClockFaceColor.a));

                var DClock = digitalBaseClock.gameObject.GetComponent<Renderer>();
                if (DClock != null)
                    DClock.material.color = new Color(Convert.ToByte(BaseClocksConfig.ClockFaceColor.r), Convert.ToByte(BaseClocksConfig.ClockFaceColor.g), Convert.ToByte(BaseClocksConfig.ClockFaceColor.b), Convert.ToByte(BaseClocksConfig.ClockFaceColor.a));
                ...
                KnownTechHandler.AddRequirementForUnlock(digitalClockBuildable.Info.TechType, TechType.ArcticPeeper);
    ...
    internal class BaseClockBuildable : CustomPrefab
    {
        ...
        public BaseClockBuildable(string classId, string displayName, string description, string iconName, GameObject prefab)
            : base(classId, displayName, description, RamuneLib.Utils.ImageUtils.GetUnitySprite(iconName))
        {
            m_Prefab = prefab;
           ;
            m_IconName = iconName;
        ...
        {
            return "./BepInEx/plugins/BaseClocks_BZ/Assets/";
        }

        public string IconFileName => m_IconName;

        public  TechType RequiredForUnlock => TechType.ArcticPeeper;
