...
namespace BaseClocks
{
    ...
    internal class BaseClocksConfig
    {
        ...
        public static readonly Color32 k_DefaultColor = new Color32(115, 255, 252, 255);
        public static readonly Color32 k_BodyDefaultColor = new Color32(115, 255, 252, 255);
        ...
        [JsonProperty] private Color m_ClockBodyColor;
        ...
        public static event EventHandler<Color> OnBodyColorChanged;
        ...
        public static Color ClockBodyColor
        {
            get
            {
                return m_Instance.m_ClockBodyColor;
            }
            set
            {
                if (m_Instance.m_ClockBodyColor != value)
                {
                    m_Instance.m_ClockBodyColor = value;
                    OnBodyColorChanged?.Invoke(m_Instance, value);
                }
            }
        }
            ...
            else
            {
                ...
                if (File.Exists(OldBaseClocksConfig.k_OldConfigPath))
                {
                    ...
                    if (oldConfig != null)
                    {
                        ...
                        ClockBodyColor = oldConfig.GetActualColor();
        ...
        public static void SetToDefaults()
        {
            ...
            ClockBodyColor = k_BodyDefaultColor;
            Save();
        }
    ...
    internal class BaseClocksModOptions : ModOptions
    {
        ...
        private const string k_ColorSliderbodyRedId = "BodyClocksClockColorR";
        private const string k_ColorSliderbodyGreenId = "BodyClocksClockColorG";
        private const string k_ColorSliderbodyBlueId = "BobyClocksClockColorB";
        ...
        public BaseClocksModOptions() : base("Base Clocks")
        {
            ...
            Color color1 = BaseClocksConfig.ClockBodyColor;
            ...
            AddItem(blue);
            var redb = ModSliderOption.Create(k_ColorSliderbodyRedId, "Body Red", 0, 255, color1.r, 0);
            redb.OnChanged += OnSlider1Changed;
            AddItem(redb);
            var greenb = ModSliderOption.Create(k_ColorSliderbodyGreenId, "Body Green", 0, 255, color1.g, 0);
            greenb.OnChanged += OnSlider1Changed;
            AddItem(greenb);
            var blueb = ModSliderOption.Create(k_ColorSliderbodyBlueId, "Body Blue", 0, 255, color1.b, 0);
            blueb.OnChanged += OnSlider1Changed;
            AddItem(blueb);
        ...
        private void OnSlider1Changed(object sender, SliderChangedEventArgs e)
        {
            switch (e.Id)
            {
                case k_ColorSliderbodyRedId:
                    BaseClocksConfig.ClockBodyColor = BaseClocksConfig.ClockBodyColor.SetBodyRed(e.Value) ;

                    break;
                case k_ColorSliderbodyGreenId:
                    BaseClocksConfig.ClockBodyColor = BaseClocksConfig.ClockBodyColor.SetBodyGreen(e.Value) ;

                    break;
                case k_ColorSliderbodyBlueId:
                    BaseClocksConfig.ClockBodyColor = BaseClocksConfig.ClockBodyColor.SetBodyBlue(e.Value);
