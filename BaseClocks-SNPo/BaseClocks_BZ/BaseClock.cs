...
namespace BaseClocks
{
    public abstract class BaseClock : HandTarget, IHandTarget, IProtoEventListener, IConstructable
    {
        ...
        protected virtual void Start()
        {
            ...
            SetColor(BaseClocksConfig.ClockBodyColor);
            BaseClocksConfig.OnBodyColorChanged += OnClockBodyColorChanged;
        }
        ...
        private void OnClockBodyColorChanged(object sender, Color e)
        {
            SetColor(e);
        }
